...
public class BookShelfSpec {
    ...
    class BooksAreArranged {
        ...
        @Test
        @DisplayName("Dans l'ordre d'insertion après arrange")
        ...
        @Test
        @DisplayName("Par critère fourni par l'utilisateur")
    ...
    class BooksAreGrouped {
        ...
        @Test
        @DisplayName("Les livres à l'intérieur de la bibliothèque sont regroupés selon les critères fournis par l'utilisateur")
